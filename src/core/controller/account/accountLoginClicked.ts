...
import { EmptyRequest, StringValue } from "../../../shared/proto/common"
 ...
 */
export async function accountLoginClicked(controller: Controller, _: EmptyRequest): Promise<StringValue> {
