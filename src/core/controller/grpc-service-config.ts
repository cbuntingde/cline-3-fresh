...
import { handleMemoryServiceRequest, handleMemoryServiceStreamingRequest } from "./memory/index"
...
export const serviceHandlers: Record<string, ServiceHandlerConfig> = {
	...
	"cline.MemoryService": {
		requestHandler: handleMemoryServiceRequest,
		streamingHandler: handleMemoryServiceStreamingRequest,
	},
}
