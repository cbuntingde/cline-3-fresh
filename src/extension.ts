...
import { initializeMemoryService } from "./core/controller/memory/initializeMemoryService"
...
export async function activate(context: vscode.ExtensionContext) {
	...
	try {
		await initializeMemoryService(sidebarWebview.controller)
		Logger.log("Memory service initialized successfully")
	} catch (error) {
		Logger.log("Failed to initialize memory service: " + error)
	}
