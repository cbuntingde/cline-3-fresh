...
async function main() {
	...
	const tsProtocCommand = [
		...
		"--ts_proto_opt=outputServices=generic-definitions,env=node,esModuleInterop=true,useDate=false,useOptionals=messages,useGlobalThis=true,oneof=unions",
		...protoFiles,
	].join(" ")
	try {
