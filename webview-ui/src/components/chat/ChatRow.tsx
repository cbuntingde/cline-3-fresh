		...
		switch (type) {
			...
			case "command":
				return [
					...
					<span style={{ color: normalColor, fontWeight: "bold" }}>Command Execution</span>,
				]
			case "use_mcp_server":
				...
				return [
					...
					<span className="ph-no-capture" style={{ color: normalColor, fontWeight: "bold", wordBreak: "break-word" }}>
						{mcpServerUse.type === "use_mcp_tool" ? "Tool Usage" : "Resource Access"} on the{" "}
				...
				case "completion_result":
					return [
						...
						<span style={{ color: normalColor, fontWeight: "bold" }}>Task Completed</span>,
					]
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>File Editing</span>
						</div>
						<CodeAccordian
				...
				return (
					<>
						<div style={headerStyle}>
							...
							{tool.operationIsLocatedInWorkspace === false &&
								toolIcon("sign-out", "yellow", -90, "This file is outside of your workspace")}
							<span style={{ fontWeight: "bold" }}>File Creation</span>
						</div>
						<CodeAccordian
							isLoading={message.partial}
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? "Directory Listing" : "Directory Listed"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
					...
					<>
						<div style={headerStyle}>
							...
							{tool.operationIsLocatedInWorkspace === false &&
								toolIcon("sign-out", "yellow", -90, "This is outside of your workspace")}
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? "Recursive Directory Listing" : "Recursive Directory Listed"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
					...
					<>
						<div style={headerStyle}>
							...
							{tool.operationIsLocatedInWorkspace === false &&
								toolIcon("sign-out", "yellow", -90, "This file is outside of your workspace")}
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? "Code Definitions" : "Code Definitions Listed"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
					...
					<>
						<div style={headerStyle}>
							...
							{tool.operationIsLocatedInWorkspace === false &&
								toolIcon("sign-out", "yellow", -90, "This is outside of your workspace")}
							<span style={{ fontWeight: "bold" }}>
								Searching for <code>{tool.regex}</code>
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? "Web Fetch" : "Web Content Retrieved"}
							</span>
						</div>
						<div
						style={{
					...
					return (
						<>
							<div style={headerStyle}>
								...
								<span style={{ color: normalColor, fontWeight: "bold" }}>New Task</span>
							</div>
