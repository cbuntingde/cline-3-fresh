...
import { CheckCheck, FlaskConical, Info, LucideIcon, Settings, SquareMousePointer, SquareTerminal, Webhook, Zap, Brain } from "lucide-react"
import { memo, useCallback, useEffect, useRef, useState } from "react"
import { useEvent } from "react-use"
import { Tab, TabContent, TabHeader, TabList, TabTrigger } from "../common/Tab"
import { TabButton } from "../mcp/configuration/McpConfigurationView"
import ApiOptions from "./ApiOptions"
import AutoApproveSettingsSection from "./AutoApproveSettingsSection"
import BrowserSettingsSection from "./BrowserSettingsSection"
import FeatureSettingsSection from "./FeatureSettingsSection"
import PreferredLanguageSetting from "./PreferredLanguageSetting" // Added import
import Section from "./Section"
import SectionHeader from "./SectionHeader"
import TavilySettingsSection from "./TavilySettingsSection"
...
export const SETTINGS_TABS: SettingsTab[] = [
	...
	},
	{
		id: "memory",
		name: "AI Memory",
		tooltipText: "AI Memory & Learning Settings",
		headerText: "AI Memory & Learning",
		icon: Brain,
	},
	{
		id: "features",
...
const SettingsView = ({ onDone, targetSection }: SettingsViewProps) => {
	...
	useEffect(() => {
		const hasChanges =
			...
			tavilyApiKey !== originalState.current.tavilyApiKey
	...
	const handleCancel = useCallback(() => {
		if (hasUnsavedChanges) {
			...
			pendingAction.current = () => {
				...
				// Reset Tavily API key
				if (typeof setTavilyApiKey === "function") {
					setTavilyApiKey(originalState.current.tavilyApiKey)
				}
				// Close settings view
				onDone()
			}
				...
				{(() => {
					...
					return (
						<TabContent className="flex-1 overflow-auto">
							...
							{/* Auto-approve Settings Tab */}
							{activeTab === "auto-approve" && (
								<div>
									{renderSectionHeader("auto-approve")}
									<Section>
