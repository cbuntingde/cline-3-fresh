		...
		<div style={{ display: "flex", flexDirection: "column", gap: 5, marginBottom: isPopup ? -10 : 0 }}>
			...
			{selectedProvider === "openai" && (
				<div>
					...
					<VSCodeTextField
						value={apiConfiguration?.openAiImageModelId || ""}
						style={{ width: "100%", marginBottom: 10 }}
						onInput={handleInputChange("openAiImageModelId")}
						placeholder={"Enter Image Model ID (e.g. z-image-turbo)..."}>
						<span style={{ fontWeight: 500 }}>Image Model ID</span>
					</VSCodeTextField>
