...
import { createGrpcClient } from "./grpc-client-base.ts"
...
import { MemoryServiceDefinition } from "@shared/proto/memory"
...
const MemoryServiceClient = createGrpcClient(MemoryServiceDefinition)
